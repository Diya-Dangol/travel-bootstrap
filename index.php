<?php include('includes/header.php'); ?>
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 mb-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="float-md-right float-lg-right float-sm-left">
    ...
    <div class="jumbotron jumbotron-fluid black-overlay cardBanner" style="background-image: url(assets/vacations.jpg)">
        <div class="container">
            <div class="sectionHeading col-12 text-center">
                <h2>We Accept</h2>
            </div>
            ...
            <div class="row justify-content-center">
                <div class="mr-5 mr-xs-2 ml-5 ml-xs-2 mb-4 mb-md-0">
                    <div class="card" style="width:180px;">
                        <img class="card-img-top img-fluid rounded-circle" src="assets/beijing.jpg" alt="Card image cap">
                        <div class="card-body text-center">
                            <article class='card-text'>
    ...
    <section class="bg-transparent">
        <div class="container">
            ...
            <div class="col-xs-12 col-sm-12 col-md-4 mb-4 mb-md-0">
                    <div class="card">
                        <img src="assets/monkey.jpg" class="card-img-top img-fluid rounded-circle margin" >
                        <div class="card-body text-center">
